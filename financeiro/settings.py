...
# Pasta static na raiz do projeto para arquivos globais (PWA, manifest, service-worker, etc)
# Em desenvolvimento, o Django serve automaticamente de STATICFILES_DIRS
STATICFILES_DIRS = [
